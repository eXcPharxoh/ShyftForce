...
const M = {
  ...
  jobs:            { href: "/hr/jobs",                  label: "Hiring · Job postings", icon: Briefcase, role: "manager" },
  logBook:         { href: "/log-book",                 label: "Manager log book",  icon: BookOpen, role: "manager" },
  ...
  // Restaurant
  tips:            { href: "/tips",                     label: "Tip Pooling",       icon: Receipt, role: "manager" },
  // Security
  ...
  clientBilling:   { href: "/reports/client-billing",   label: "Client Billing",    icon: FileBarChart, role: "manager" },
  // Cross-vertical
  pos:             { href: "/settings/pos",             label: "POS Connections",   icon: Plug },
  ewa:             { href: "/ewa",                      label: "Get paid early",    icon: Wallet },
  ewaSettings:     { href: "/settings/ewa",             label: "EWA settings",      icon: DollarSign, role: "manager" },
  workerProfile:   { href: "/worker/profile",           label: "Worker profile",    icon: UserCircle },
  network:         { href: "/network",                  label: "Worker Network",    icon: Globe, role: "manager" },
  networkAvail:    { href: "/network/available",        label: "Network shifts",    icon: Globe },
  recurring:       { href: "/settings/recurring-shifts",label: "Recurring patterns",icon: Repeat, role: "manager" },
  availability:    { href: "/settings/availability",    label: "My availability",   icon: CalendarX },
  pto:             { href: "/settings/pto",             label: "Time-off policies", icon: Plane, role: "manager" },
  blackouts:       { href: "/settings/time-off-blackouts", label: "Time-off blackouts", icon: CalendarX, role: "manager" },
  billing:         { href: "/settings/billing",         label: "Billing & plan",    icon: CreditCard },
  locations:       { href: "/settings/locations",       label: "Locations",         icon: MapPin, role: "manager" },
  integrations:    { href: "/settings/integrations",    label: "Integrations",      icon: Wrench, role: "manager" },
  audit:           { href: "/settings/audit",           label: "Audit log",         icon: FileText, role: "manager" },
  ...
  stations:        { href: "/stations",                 label: "Section assignments", icon: MapPinned, role: "manager" },
...
export const VERTICALS: Record<VerticalKey, VerticalConfig> = {
  grocery: {
    ...
    modules: [
      ...
      { ...M.recurring }, { ...M.availability }, { ...M.pto }, { ...M.blackouts }, { ...M.jobs }, { ...M.logBook },
