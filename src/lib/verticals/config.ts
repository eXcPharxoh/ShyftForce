...
const M = {
  ...
  jobs:            { href: "/hr/jobs",                  label: "Hiring · Job postings", icon: Briefcase },
  logBook:         { href: "/log-book",                 label: "Manager log book",  icon: BookOpen },
  ...
  blackouts:       { href: "/settings/time-off-blackouts", label: "Time-off blackouts", icon: CalendarX },
