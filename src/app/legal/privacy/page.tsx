    ...
    <div>
      ...
      <div className="mt-10 space-y-6 text-ink-700 dark:text-ink-300 leading-relaxed">
        <div className="rounded-xl border border-amber-200 dark:border-amber-500/30 bg-amber-50 dark:bg-amber-500/10 px-4 py-3 text-[13px] text-amber-900 dark:text-amber-200">
          <b>Draft privacy policy.</b> This is a starting draft, not a jurisdiction-specific legal document. For GDPR/CCPA-grade compliance contact <a href="mailto:privacy@shyftforce.com" className="underline">privacy@shyftforce.com</a> for a counsel-reviewed version.
        </div>

        <section>
          <h2 className="text-2xl font-bold tracking-tight-2 text-ink-900 dark:text-ink-50 mt-8 mb-3">1. What we collect</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold tracking-tight-2 text-ink-900 dark:text-ink-50 mt-8 mb-3">2. How we use it</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold tracking-tight-2 text-ink-900 dark:text-ink-50 mt-8 mb-3">3. Your rights</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold tracking-tight-2 text-ink-900 dark:text-ink-50 mt-8 mb-3">4. Subprocessors</h2>
